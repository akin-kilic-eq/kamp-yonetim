...
import { Plus, Search, Filter, Edit, Trash2, Eye, Upload, Trash, ArrowLeft } from 'lucide-react';
import { useRouter, useParams } from 'next/navigation';
import AddPersonnelModal from '../../../../personnel/components/AddPersonnelModal';
import EditPersonnelModal from '../../../../personnel/components/EditPersonnelModal';
import ViewPersonnelModal from '../../../../personnel/components/ViewPersonnelModal';
import ImportPersonnelModal from '../../../../personnel/components/ImportPersonnelModal';
import DeleteAllPersonnelModal from '../../../../personnel/components/DeleteAllPersonnelModal';
...
export default function ManageSitePersonnelPage() {
  ...
  const siteName = decodeURIComponent(params.site as string);
  ...
  const fetchPersonnel = async () => {
    try {
      ...
      // "Bilinmeyen Şantiye" için site filtresi ekleme
      if (siteName !== 'Bilinmeyen Şantiye') {
        params.append('site', siteName);
      } else {
        // Bilinmeyen şantiye için site alanı boş olan personeli getir
        params.append('unknownSite', 'true');
      }
  ...
  useEffect(() => {
    ...
    fetchPersonnel();
  }, [debouncedSearchTerm, statusFilter, siteName]);
  ...
  const handleDeleteAllPersonnel = async () => {
    try {
      const response = await fetch(`/api/personnel?site=${encodeURIComponent(siteName)}`, {
        method: 'DELETE',
      });
    ...
    >
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                Geri Dön
                 ...
                 {siteName === 'Bilinmeyen Şantiye' ? 'Site Bilgisi Olmayan Personel' : `${siteName} - Personel Yönetimi`}
               </h1>
            </div>
      ...
      {/* Modaller */}
         ...
         <AddPersonnelModal
           ...
           defaultSite={siteName === 'Bilinmeyen Şantiye' ? '' : siteName}
         />
       )}
